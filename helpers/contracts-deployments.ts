...
export const deployAaveOracle = async (
  ...
  withSaveAndVerify(
    await new EvolutionOracleFactory(await getFirstSigner()).deploy(...args),
    eContractid.EvolutionOracle,
    args,
    verify
  );
...
export const deployAaveProtocolDataProvider = async (
  ...
  withSaveAndVerify(
    await new EvolutionProtocolDataProviderFactory(await getFirstSigner()).deploy(addressesProvider),
    eContractid.EvolutionProtocolDataProvider,
    [addressesProvider],
    verify
  );
...
export const deployGenericAToken = async (
  ...
  const instance = await withSaveAndVerify(
    await new EvolutionTokenFactory(await getFirstSigner()).deploy(),
    eContractid.EvolutionToken,
    [],
    verify
  );
...
export const deployMockAToken = async (
  ...
  const instance = await withSaveAndVerify(
    await new MockETokenFactory(await getFirstSigner()).deploy(),
    eContractid.MockEToken,
    [],
    verify
  );
