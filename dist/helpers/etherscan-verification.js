...
exports.checkVerification = exports.runTaskWithRetry = exports.verifyContract = exports.SUPPORTED_ETHERSCAN_NETWORKS = void 0;
...
exports.verifyContract = async (address, constructorArguments, libraries) => {
    ...
    try {
        ...
        await exports.runTaskWithRetry('verify', params, times, msDelay, cleanup);
    }
    catch (error) { }
};
exports.runTaskWithRetry = async (task, params, times, msDelay, cleanup) => {
    let counter = times;
    await delay(msDelay);
    try {
        if (times > 1) {
        ...
        await exports.runTaskWithRetry(task, params, counter, msDelay, cleanup);
    }
};
