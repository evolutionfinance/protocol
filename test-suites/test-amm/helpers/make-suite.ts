...
import { EvolutionToken } from '../../../types/EvolutionToken';
...
export interface TestEnv {
  ...
  oracle: PriceOracle;
  helpersContract: EvolutionProtocolDataProvider;
  weth: WETH9Mocked;
  aWETH: EvolutionToken;
  dai: MintableERC20;
  aDai: EvolutionToken;
  usdc: MintableERC20;
  aave: MintableERC20;
...
const testEnv: TestEnv = {
  ...
  helpersContract: {} as EvolutionProtocolDataProvider,
  oracle: {} as PriceOracle,
  weth: {} as WETH9Mocked,
  aWETH: {} as EvolutionToken,
  dai: {} as MintableERC20,
  aDai: {} as EvolutionToken,
