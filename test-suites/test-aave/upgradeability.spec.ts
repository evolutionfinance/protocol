...
import { MockEToken } from '../../types/MockEToken';
...
makeSuite('Upgradeability', (testEnv: TestEnv) => {
  ...
  before('deploying instances', async () => {
    ...
    const aTokenInstance = await deployMockAToken([
      ...
      ZERO_ADDRESS,
      ZERO_ADDRESS,
      'Evolution Interest bearing DAI updated',
      'aDAI',
      '0x10'
    ]);
    ...
    const stableDebtTokenInstance = await deployMockStableDebtToken([
      ...
      dai.address,
      ZERO_ADDRESS,
      'Evolution stable debt bearing DAI updated',
      'stableDebtDAI',
      '0x10'
    ]);
    ...
    const variableDebtTokenInstance = await deployMockVariableDebtToken([
      ...
      dai.address,
      ZERO_ADDRESS,
      'Evolution variable debt bearing DAI updated',
      'variableDebtDAI',
      '0x10'
    ]);
  ...
  it('Upgrades the DAI Atoken implementation ', async () => {
    ...
    expect(tokenName).to.be.eq('Evolution Interest bearing DAI updated', 'Invalid token name');
  });
